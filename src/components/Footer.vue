            ...
            <div class="container">
                ...
                <div class="row" style="margin-top:30px; padding-top:30px; margin-bottom:5px;">
                    ...
                    <div class="col-lg-3 col-md-3 col-xs-12 text-right">
                        <a target="_blank" href="https://instagram.com/ridwanzal"><i class="fa fa-instagram social2" style="font-size:1.5em;"></i></a>
                        <a target="_blank" href="https://behance.net/ridwanzal"><i class="fa fa-behance social2" style="font-size:1.5em;"></i></a>
                        <a href="#"><i class="fa fa-linkedin" style="font-size:1.5em;color:#fff;"></i></a>
                    </div>
                </div>
            </div>
  </div>
